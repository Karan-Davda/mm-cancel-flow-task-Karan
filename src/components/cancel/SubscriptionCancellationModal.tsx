      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center md:items-center">
        ...
        <div className={`relative bg-white rounded-t-2xl md:rounded-2xl shadow-2xl w-full md:mx-4 md:mt-0 mt-auto h-[85vh] md:h-auto flex flex-col overflow-hidden ${
          ...
          <div className="relative pt-7 pb-4 md:pb-4 md:pt-7 border-b border-gray-300 flex-shrink-0">
            {/* Back button - show when in flow - Desktop only */}
            {flow && (
              <button
                onClick={() => {
                  if (step === 1) {
            ...
            {/* Title and Progress indicator - Mobile: stacked below title, Desktop: side by side */}
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between md:justify-center md:gap-7">
              <h1 className="text-gray-800 text-md ml-4 md:text-sm font-semibold font-dm-sans text-left">Subscription Cancellation</h1>
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <div className="flex flex-col md:flex-row overflow-hidden">
              ...
              {/* Desktop Right section - Image - Hidden on mobile for Step 1 and Step 2 */}
              <div className={`${
                flow === 'found' && (step === 1 || step === 2) 
                  ? 'hidden md:block' 
                  : 'block'
              } flex-shrink-0 p-3 ${
                flow === 'found' && step === 1 
